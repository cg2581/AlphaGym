...
import com.ps12027_cuongnt.alphasupplements.adapter.EmployeeAdapter
...
class EmployeeFragment : Fragment() {
    ...
    private var employeeList: ArrayList<User> = ArrayList()
    ...
    override fun onCreateView(
        ...
        tvTitle.text = "Danh sách nhân viên"
    ...
    override fun onResume() {
        super.onResume()
        employeeList.clear()
        employeeList.addAll(alphaDAO!!.getAllEmployee())
        employeeAdapter = EmployeeAdapter(context!!, employeeList)
        rcv!!.adapter = employeeAdapter
